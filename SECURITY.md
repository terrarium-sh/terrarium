...
secrets or credentials in the report.

The [security model](docs/security.md) describes Terra's intended VM boundary,
the authority a recipe grants, and limits that are outside that boundary.
